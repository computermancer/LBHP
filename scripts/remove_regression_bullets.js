...
async function removeRegressionBullets() {
            ...
            for (let exercise = 1; exercise <= 5; exercise++) {
                ...
                try {
                    ...
                    if (regressionMatch) {
                        ...
                        // Keep all lines except the last two
                        const newLines = lines.slice(0, -2);
                        
                        // Reconstruct the array with the new lines
    ...
    console.log('All regression bullet points have been removed successfully!');
}

removeRegressionBullets().catch(console.error);
