  ...
  return (
    <div className="bg-zinc-900 border border-zinc-700 rounded-lg mb-4">
      <button
        ...
        className="w-full bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-3 px-4 rounded-t-lg border border-gray-600 flex items-center justify-center"
      >
