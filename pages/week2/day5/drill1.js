      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Lie on your stomach with your forehead resting on your hands.</li>
            <li>Keep your legs straight and relaxed.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Inhale deeply, allowing your ribs to expand into the ground.</li>
            <li>Exhale slowly, feeling the ribs gently compress.</li>
            <li>Maintain a relaxed neck and shoulders throughout.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Rib expansion into the ground during inhalation</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            ...
            <li>Tensing the neck or shoulders</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Pain or discomfort in the back or ribs</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Place a pillow under your chest for support.</li>
