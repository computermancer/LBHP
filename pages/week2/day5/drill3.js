  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 3: Seated Spine Twist with Arm Reach</h2>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sit upright in a firm chair with feet flat on the ground.</li>
            <li>Place your hands crossed over your chest.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Inhale to prepare, maintaining an upright posture.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2</li>
            <li>Reps: 5–8 slow rotations per side</li>
            <li>Breath: Inhale to center, exhale during rotation</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            ...
            <li>Stability through the core</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Over-rotating or losing control</li>
            <li>Moving too quickly</li>
            <li>Losing upright posture</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Pain in the spine or ribs</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Perform without arm reach.</li>
