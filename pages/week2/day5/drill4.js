  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 4: Supine Marching with Pelvic Control</h2>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Lie on your back with knees bent and feet flat on the ground.</li>
            <li>Place your hands resting by your sides or on your lower ribs.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Exhale and lift one knee toward your chest while maintaining rib and pelvis control.</li>
            <li>Inhale and return the leg to the starting position.</li>
            <li>Alternate sides with each repetition.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2</li>
            <li>Reps: 5–8 slow marches per side</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Core and pelvis control</li>
            <li>Smooth leg motion</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Pain in the hips or low back</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Limit the height of leg lift.</li>
            <li>Place hands under the pelvis for support.</li>
          </ul>
        </section>
      </main>
    </>
