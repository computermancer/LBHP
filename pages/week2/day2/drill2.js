  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 2: Seated Hip Hinge with Breath</h2>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Inhale and expand your ribs laterally.</li>
            <li>Exhale and allow your ribs to relax.</li>
            <li>Focus on maintaining pelvic stability.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2</li>
            <li>Reps: 5–8 slow breaths per set</li>
            <li>Breath: Inhale for 4 counts, exhale for 4 counts</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Rib expansion during inhalation</li>
            <li>Gentle rib compression during exhalation</li>
            <li>Relaxed breathing pattern</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Forcing the breath</li>
            <li>Shallow chest breathing</li>
            <li>Tensing the shoulders</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Pain or discomfort in the ribs</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Place a pillow under your head for support.</li>
            <li>Reduce the breathing count to 3 counts.</li>
          </ul>
        </section>
      </main>
    </>
