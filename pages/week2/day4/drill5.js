...
export default function Drill5SeatedBreathPelvicAwareness() {
  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 5: Seated Breath with Pelvic Awareness</h2>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2</li>
            <li>Reps: 5–8 slow presses per set</li>
