      ...
      <main className="px-8 text-gray-200 font-sans pt-4 pb-2">
        <div className="max-w-[500px] mx-auto">
          <div className="bg-zinc-900 rounded-lg border border-zinc-700 p-3 mb-3">
            ...
            <h2 className="text-orange-300 text-2xl font-bold mb-0 leading-relaxed" style={{ lineHeight: '1.5em', height: '3em' }}>Drill 4: Supine 90-90 Leg Lowering</h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Lie on your back with hips and knees bent to 90 degrees.</li>
                <li>Arms resting by your sides or placed gently on your ribs.</li>
              </ul>
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Exhale and slowly lower one leg toward the floor.</li>
                <li>Keep the opposite leg and pelvis stable.</li>
                <li>Inhale to return to the starting position.</li>
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              <div className="space-y-2">
                ...
                <div className="text-lg text-white leading-relaxed">
                  <span className="text-orange-300 font-semibold text-xl">Breath:</span> Exhale to lower, inhale to return
                </div>
                <div className="text-lg text-white leading-relaxed">
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Core control and stability.</li>
                <li>Smooth leg movement without pelvic shifting.</li>
              </ul>
              
              <h4 className="text-orange-300 text-xl font-semibold mb-2">What to Avoid</h4>
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Arching the lower back or losing core engagement.</li>
              </ul>
              
              <h4 className="text-orange-300 text-xl font-semibold mb-2">Red Flags</h4>
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Low back pain or instability.</li>
              </ul>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Lower legs less if maintaining control is difficult.</li>
              </ul>
            </div>
          </div>
        </div>
