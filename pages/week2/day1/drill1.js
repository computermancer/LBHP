  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 1: Supine Rib Expansion with Breath</h2>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Inhale deeply, feeling your ribs expand.</li>
            <li>Exhale slowly, allowing your ribs to relax.</li>
            <li>Focus on lateral rib expansion.</li>
          </ul>
        </section>
