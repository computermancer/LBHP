  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 3: Side-Lying Hip IR with Breath</h2>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Inhale and rotate your top knee outward.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            ...
            <li>Breath: Inhale to rotate, exhale to return</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Rolling the pelvis</li>
            <li>Moving too quickly</li>
            <li>Holding tension in the hip</li>
          </ul>
        </section>
