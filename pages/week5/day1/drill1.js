  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 1: Bodyweight Squats with Rib Control</h2>
...
<li>Inhale to return to standing.</li>
        ...
        <ul className="list-disc list-inside text-white text-lg">
<li>Sets: 2–3</li>
<li>Reps: 10–12 slow, controlled reps</li>
<li>Breath: Exhale to lower, inhale to rise</li>
