      ...
      <main className="px-8 text-gray-200 min-h-screen font-sans">
        <div className="max-w-[500px] mx-auto py-8">
          ...
          <div className="space-y-6">
            ...
            <section>
              <h3 className="text-orange-300 text-xl font-semibold mb-4">My Journey</h3>
              <p className="text-base">
            ...
            <section>
              <h3 className="text-orange-300 text-xl font-semibold mb-4">About This Program</h3>
              <p className="text-base mb-4">
            ...
            <section>
              <h3 className="text-orange-300 text-xl font-semibold mb-4">Looking Forward</h3>
              <p className="text-base">
            ...
            <section>
              <h3 className="text-orange-300 text-xl font-semibold mb-4">Connect With Me</h3>
              <p className="text-base mb-4">You can find links to my website and social media below.</p>
              <div className="space-y-4">
                <div>
                  <div className="flex items-center mb-1">
                    <FaGlobe className="text-white mr-3 text-xl" />
                    <span className="text-amber-200 font-semibold">Website</span>
                  </div>
                  <div className="ml-8">
                    <a href="https://www.mateobravo.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
                      www.mateobravo.com
                    </a>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <FaFacebook className="text-[#1877F2] mr-3 text-xl" />
                    <span className="text-amber-200 font-semibold">Facebook Page</span>
                  </div>
                  <div className="ml-8">
                    <a href="https://www.facebook.com/MateoBravoPersonalTraining" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <FaYoutube className="text-[#FF0000] mr-3 text-xl" />
                    <span className="text-amber-200 font-semibold">Youtube Channel</span>
                  </div>
                  <div className="ml-8">
                    <a href="https://www.youtube.com/@MateoBravoPersonalTraining" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
                ...
                <div>
                  <div className="flex items-center mb-1">
                    <FaInstagram className="text-[#F490A5] mr-3 text-xl" />
                    <span className="text-amber-200 font-semibold">Personal Instagram</span>
                  </div>
                  <div className="ml-8">
                    <a href="https://www.instagram.com/flatfootmatt/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
