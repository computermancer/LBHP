    ...
    <>
      ...
      <main className="p-8 text-gray-200 min-h-screen font-sans">
        ...
        <div className="space-y-6">
          ...
          <div>
            <Link href="/week3/day1/drill1" className="block w-full sm:w-[500px] bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded mb-2">
          ...
          <div>
            <Link href="/week3/day1/drill2" className="block w-full sm:w-[500px] bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded mb-2">
          ...
          <div>
            <Link href="/week3/day1/drill3" className="block w-full sm:w-[500px] bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded mb-2">
          ...
          <div>
            <Link href="/week3/day1/drill4" className="block w-full sm:w-[500px] bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded mb-2">
          ...
          <div>
            <Link href="/week3/day1/drill5" className="block w-full sm:w-[500px] bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded mb-2">
