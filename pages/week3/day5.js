      ...
      <main className="px-8 text-gray-200 font-sans pt-6 pb-8">
        <div className="max-w-[500px] mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div>
              <Link href="/week3/day5/drill5" className="block w-full bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded">
                Drill 5: Side-Lying Hip IR and Breathing
              </Link>
              <p className="text-lg text-white mt-2">Enhance internal hip rotation and improve breath coordination.</p>
            </div>
          </div>
        </div>
      </main>
