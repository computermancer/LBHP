  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 3: Quadruped Arm and Leg Reach with Control</h2>
...
<li>Breath: Exhale to extend, inhale to return</li>
