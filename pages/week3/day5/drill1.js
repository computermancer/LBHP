      ...
      <main className="px-8 text-gray-200 font-sans pt-4 pb-2">
        <div className="max-w-[500px] mx-auto">
          <div className="bg-zinc-900 rounded-lg border border-zinc-700 p-3 mb-3">
            <h1 className="text-orange-300 text-4xl font-bold mb-1">Week 3 - Day 5</h1>
            <h2 className="text-orange-300 text-2xl font-bold mb-0 leading-relaxed" style={{ lineHeight: '1.5em', height: '3em' }}>Drill 1: Crocodile Breathing with Rib Expansion</h2>
          </div>
          <div className="h-1"></div>
          <DrillNavBar 
            prevDrill="/week3/day4/drill5" 
            currentDay="/week3/day5" 
            nextDrill="/week3/day5/drill2" 
          />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Lie face down with forehead resting on hands.</li>
                <li>Legs extended, toes pointing slightly outward.</li>
              </ul>
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Inhale deeply, feeling your belly push into the floor.</li>
                <li>Exhale softly, allowing your ribs and belly to fall naturally.</li>
                <li>Focus on expanding your breath into the back and sides of your ribcage.</li>
              </ul>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Belly pressing into the floor with each inhale</li>
                <li>Relaxed, steady breathing</li>
              </ul>
              
              <h4 className="text-orange-300 text-xl font-semibold mb-2">What to Avoid</h4>
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Shallow chest breathing</li>
                <li>Holding tension in the upper body</li>
              </ul>
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Place a pillow under your belly for added comfort.</li>
              </ul>
            </div>
          </div>
        </div>
