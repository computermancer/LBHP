...
export default function Drill4WallSupportedMarchingwithRibControl() {
  return (
      ...
      <main className="px-8 text-gray-200 font-sans pt-4 pb-2">
        <div className="max-w-[500px] mx-auto">
          <div className="bg-zinc-900 rounded-lg border border-zinc-700 p-3 mb-3">
            ...
            <h2 className="text-orange-300 text-2xl font-bold mb-0 leading-relaxed" style={{ lineHeight: '1.5em', height: '3em' }}>Drill 4: Wall Supported Marching with Rib Control</h2>
          </div>
          <div className="h-1"></div>
          <DrillNavBar 
            prevDrill="/week3/day5/drill3" 
            currentDay="/week3/day5" 
            nextDrill="/week3/day5/drill5" 
          />
