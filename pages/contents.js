...
<div className="fixed top-0 left-0 right-0 z-50 bg-gray-900">
      ...
      <main className="pt-20 p-8 text-gray-200 min-h-screen font-sans">
        <h1 className="text-orange-300 text-3xl font-bold mt-6 mb-6">Program Overview</h1>
        ...
        <section className="mb-8">
          ...
          {/* Day 1 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 1 - Groundwork and Awareness</h3>
          ...
          {/* Day 2 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 2 - Rib Expansion and Hip Hinge Focus</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 3 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 3 - Breath Control and Rhythmic Movement</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 4 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 4 - Pelvic and Rib Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 5 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 5 - Breath, Spinal Flexion, and Core Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
        ...
        <section className="mb-8">
          ...
          {/* Day 1 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 2 - Day 1 - Rib Expansion and Hip Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 2 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 2 - Thoracic Rotation and Posterior Chain Activation</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 3 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 3 - Pelvic Control and Hip Stability</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 4 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 4 - Rib Shift and Thoracic Mobility</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 5 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 1 - Day 5 - Breath, Rotation, and Pelvic Coordination</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
        ...
        <section className="mb-8">
          ...
          {/* Day 1 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 3 - Day 1 - Pelvic Control and Breath Integration</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 2 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 3 - Day 2 - Rib and Hip Coordination</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 3 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 3 - Day 3 - Spinal Mobility and Core Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
              ...
              <tbody>
                ...
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Seated Posterior Pelvic Rocking</td>
                  <td className="border border-gray-600 p-2 text-base">Enhance pelvic control and improve awareness of movement.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Supine 90-90 Rib Shift with Breath</td>
                  <td className="border border-gray-600 p-2 text-base">Build core stability and enhance breath-guided movement.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Wall Supported Squat Hold with Reach</td>
                  <td className="border border-gray-600 p-2 text-base">Increase confidence in squat position with upper body movement.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Supine Spine Twist with Breath</td>
                  <td className="border border-gray-600 p-2 text-base">Improve thoracic rotation with breath control.</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          {/* Day 4 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 3 - Day 4 - Hip and Ribcage Stability</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
              ...
              <tbody>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Supine Hip Shifts with Rib Control</td>
                  <td className="border border-gray-600 p-2 text-base">Develop control of pelvic shifts while maintaining rib stability.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Seated Thoracic Flexion and Extension</td>
                  <td className="border border-gray-600 p-2 text-base">Improve thoracic spine mobility and postural control.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Quadruped Arm and Leg Reach with Control</td>
                  <td className="border border-gray-600 p-2 text-base">Build core and shoulder stability while maintaining neutral spine.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Wall Hamstring Press with Hip Awareness</td>
                  <td className="border border-gray-600 p-2 text-base">Reinforce hamstring activation and pelvis control.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Supported Side-Lying Hip Abduction</td>
          ...
          {/* Day 5 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 3 - Day 5 - Breath, Mobility, and Relaxation</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
              ...
              <tbody>
                ...
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Seated Spine Twist with Arm Reach</td>
                  <td className="border border-gray-600 p-2 text-base">Improve thoracic rotation with coordinated breath and movement.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Wall Supported Marching with Rib Control</td>
                  <td className="border border-gray-600 p-2 text-base">Build ribcage control and core stability.</td>
                </tr>
                <tr className="hover:bg-gray-800">
                  <td className="border border-gray-600 p-2 text-base">Side-Lying Hip IR and Breathing</td>
                  <td className="border border-gray-600 p-2 text-base">Enhance internal hip rotation and improve breath coordination.</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-8">
          ...
          {/* Day 1 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 4 - Day 1 - Rib and Pelvic Stability in Motion</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 2 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 4 - Day 2 - Core and Pelvic Stability in Action</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 3 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 4 - Day 3 - Spinal Control and Hip Mobility</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 4 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 4 - Day 4 - Hip and Rib Control under Load</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 5 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 4 - Day 5 - Breath, Mobility, and Relaxation</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
        ...
        <section className="mb-8">
          ...
          {/* Day 1 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 5 - Day 1: Lower Body Control and Strength</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 2 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 5 - Day 2: Single Leg and Hip Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 3 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 5 - Day 3: Posterior Chain and Hip Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
 ...
 {/* Day 4 */}
 <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 5 - Day 4: Upper Body and Core Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
          ...
          {/* Day 5 */}
          <div className="mb-4">
            <h3 className="text-xl font-semibold mb-2">Week 5 - Day 5: Mobility, Breath, and Control</h3>
            <table className="w-full text-left border-collapse border border-gray-700 table-fixed">
              <thead>
                <tr className="bg-gray-700 text-white">
                  <th className="border border-gray-600 p-2 text-lg">Drill Name</th>
