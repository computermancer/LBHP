  ...
  return (
    <>
      ...
      <main className="p-8 text-gray-200 min-h-screen font-sans">
        <h1 className="text-orange-300 text-3xl font-bold mb-6">Week 2: Rib Control & Hip Integration</h1>

        <div className="flex gap-1 mb-6">
          <Link href="/week2/day1" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-2 rounded text-center">
            Day 1
          </Link>
          <Link href="/week2/day2" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-2 rounded text-center">
            Day 2
          </Link>
          <Link href="/week2/day3" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-2 rounded text-center">
            Day 3
          </Link>
          <Link href="/week2/day4" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-2 rounded text-center">
            Day 4
          </Link>
          <Link href="/week2/day5" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-2 rounded text-center">
            Day 5
          </Link>
        </div>
