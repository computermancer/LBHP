    ...
    <>
      ...
      <main className="p-8 text-gray-200 min-h-screen font-sans">
        ...
        <div className="flex space-x-4 mb-6">
          <Link href="/week2/day1" className="bg-gray-700 hover:bg-gray-600 text-orange-300 text-lg font-semibold py-2 px-4 rounded">
            Day 1
          </Link>
          <Link href="/week2/day2" className="bg-gray-700 hover:bg-gray-600 text-orange-300 text-lg font-semibold py-2 px-4 rounded">
            Day 2
          </Link>
          <Link href="/week2/day3" className="bg-gray-700 hover:bg-gray-600 text-orange-300 text-lg font-semibold py-2 px-4 rounded">
            Day 3
          </Link>
          <Link href="/week2/day4" className="bg-gray-700 hover:bg-gray-600 text-orange-300 text-lg font-semibold py-2 px-4 rounded">
            Day 4
          </Link>
          <Link href="/week2/day5" className="bg-gray-700 hover:bg-gray-600 text-orange-300 text-lg font-semibold py-2 px-4 rounded">
            Day 5
          </Link>
        </div>
