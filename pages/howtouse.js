  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section className="bg-zinc-900 rounded-lg border border-zinc-700 p-3">
          <h2 className="text-orange-300 text-xl font-semibold mb-4">User-Led Exploration & Progression</h2>
        ...
        <section className="bg-zinc-900 rounded-lg border border-zinc-700 p-3">
          <h2 className="text-orange-300 text-xl font-semibold mb-4">Structure Meets Freedom</h2>
          <ul className="list-disc pl-6 space-y-2 text-lg leading-relaxed">
        ...
        <section className="bg-zinc-900 rounded-lg border border-zinc-700 p-3">
          <h2 className="text-orange-300 text-xl font-semibold mb-4">Drill Design for Self-Guided Learning</h2>
          <ul className="list-disc pl-6 space-y-2 text-lg leading-relaxed">
        ...
        <section className="bg-zinc-900 rounded-lg border border-zinc-700 p-3">
          <h2 className="text-orange-300 text-xl font-semibold mb-4">Building Autonomy and Confidence</h2>
          <p className="text-lg leading-relaxed mb-4">
