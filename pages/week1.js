  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-2xl font-semibold mb-8">Awareness & Activation</h2>
        
        <div className="flex gap-1 max-w-[500px]">
          <Link href="/week1/day1" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-base py-1.5 px-2 rounded text-center">Day 1</Link>
          <Link href="/week1/day2" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-base py-1.5 px-2 rounded text-center">Day 2</Link>
          <Link href="/week1/day3" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-base py-1.5 px-2 rounded text-center">Day 3</Link>
          <Link href="/week1/day4" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-base py-1.5 px-2 rounded text-center">Day 4</Link>
          <Link href="/week1/day5" className="flex-1 bg-gray-700 hover:bg-gray-600 text-orange-300 text-base py-1.5 px-2 rounded text-center">Day 5</Link>
        </div>
