  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 5: Wall Supported Squat Hold</h2>
...
<li>Breathe steadily throughout the hold.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2–3</li>
            <li>Reps: 15–30 seconds per hold</li>
            <li>Breath: Maintain slow, steady breathing throughout</li>
            <li>Rest: 30–40 seconds between sets</li>
          </ul>
        </section>
