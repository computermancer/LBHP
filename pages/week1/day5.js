    ...
    <div className="min-h-screen bg-zinc-900">
      ...
      <main className="px-8 text-gray-200 font-sans pt-6 pb-8">
        <div className="max-w-[500px] mx-auto">
          ...
          <h2 className="text-orange-300 text-2xl font-bold mb-6">Breath, Spinal Flexion, and Core Control</h2>
          ...
          <div className="space-y-8">
            ...
            <div>
              <Link href="/week1/day5/drill5" className="block w-full bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded">
