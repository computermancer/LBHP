  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 4: Supine Hip Shift with Breath</h2>
...
<li>Return to neutral before switching sides.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
<li>Sets: 2–3</li>
<li>Reps: 8–10 controlled reps per side</li>
<li>Breath: Exhale during the shift, inhale to return</li>
