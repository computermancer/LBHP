    ...
    <>
      ...
      <main className="px-8 text-gray-200 min-h-screen font-sans">
        <div className="max-w-[500px] mx-auto py-8">
          <h1 className="text-orange-300 text-3xl mb-2 font-bold">Week 1 - Day 1</h1>
          <h2 className="text-orange-300 text-xl font-semibold mb-6">Groundwork and Awareness</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Link href="/week1/day1/drill5" className="block w-full bg-gray-700 hover:bg-gray-600 text-orange-300 text-xl font-semibold py-2 px-4 rounded mb-2">
