  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 4: Relaxed Spine Rocking</h2>
...
<li>Breathe steadily throughout the movement.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2–3</li>
            <li>Reps: 8–12 slow rocks</li>
            <li>Breath: Inhale as you rock forward, exhale as you rock back</li>
