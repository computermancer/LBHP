  ...
  return (
    <>
      ...
      <main className="p-8 text-white min-h-screen font-sans">
        ...
        <h2 className="text-orange-300 text-3xl font-bold mb-6">Drill 4: Supine 90-90 Reach</h2>
...
<li>Inhale and return arms to starting position without losing core control.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside text-white text-lg">
            <li>Sets: 2–3</li>
            <li>Reps: 5–8 slow, controlled reps</li>
            <li>Breath: Exhale during the reach, inhale to return</li>
