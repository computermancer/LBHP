      ...
      <main className="px-8 text-gray-200 font-sans pt-4 pb-2">
        <div className="max-w-[500px] mx-auto">
          <div className="bg-zinc-900 rounded-lg border border-zinc-700 p-3 mb-3">
            ...
            <h2 className="text-orange-300 text-2xl font-bold mb-0 leading-relaxed" style={{ lineHeight: '1.5em', height: '3em' }}>Drill 3: Seated Pelvic Rocking</h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Sit on a firm chair, feet flat, hands resting on thighs.</li>
              </ul>
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Slowly tilt the pelvis forward (arching low back) and backward (flattening low back).</li>
                <li>Let the breath guide the rhythm of your movement.</li>
                <li>Keep upper body still and relaxed.</li>
              </ul>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              <div className="space-y-2">
                ...
                <div className="text-lg text-white leading-relaxed">
                  <span className="text-orange-300 font-semibold text-xl">Reps:</span> 8 – 12 controlled reps
                </div>
                <div className="text-lg text-white leading-relaxed">
                  <span className="text-orange-300 font-semibold text-xl">Breath:</span> Inhale as you tilt forward, exhale as you tilt backward
                </div>
                <div className="text-lg text-white leading-relaxed">
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Gentle motion through the pelvis and low back.</li>
                <li>Ease and rhythm with breath.</li>
              </ul>
              
              <h4 className="text-orange-300 text-xl font-semibold mb-2">What to Avoid</h4>
              <ul className="text-lg text-white leading-relaxed list-disc pl-5 mb-4">
                <li>Tensing shoulders or upper back.</li>
                <li>Over-arching or collapsing posture.</li>
              </ul>
              
              <h4 className="text-orange-300 text-xl font-semibold mb-2">Red Flags</h4>
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Pain during any part of the movement.</li>
                <li>Inability to isolate pelvic motion.</li>
              </ul>
            </div>
            ...
            <div className="bg-zinc-900 border border-zinc-700 p-2 pb-5 rounded-lg mb-4">
              ...
              <ul className="text-lg text-white leading-relaxed list-disc pl-5">
                <li>Place hands on hips for feedback if you're unsure where the motion is coming from.</li>
              </ul>
            </div>
          </div>
        </div>
