...
export default function Ejercicio3Cambiodecostillas9090supinoconrespiracin() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 3: Cambio de Costillas 90-90 Supino con Respiración"      backButtonText="Semana 4 - Día 3"
      videoId=""
      videoStart={0}
      setup={[" Túmbate boca arriba con las caderas y las rodillas a 90 grados."," Brazos extendidos hacia el techo."]}
      instructions={[" Inhala para prepararte."," Exhale y desplace suavemente las costillas lateralmente hacia un lado."," Vuelva al centro y alterne los lados."]}
    ...
    >
      <EspDrillNavBar 
        prevDrill="/espanol/semana4/dia3/ejercicio2" 
        currentDay="/espanol/semana4/dia3" 
        nextDrill="/espanol/semana4/dia3/ejercicio4" 
