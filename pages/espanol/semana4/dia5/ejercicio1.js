...
export default function Ejercicio1RespiracionDeCocodriloConExpansionCostal() {
  return (
    <DrillTemplateEspanol
      ...
      videoStart={2248}
      setup={[
        "Acuéstate boca abajo con la frente apoyada en las manos.",
      ...
      whatToAvoid={[
        "Respiración superficial desde el pecho",
      ...
      regression={[
        "Coloca una almohada debajo del vientre para mayor comodidad."
      ]}
    />
  );
} 