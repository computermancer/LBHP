...
export default function Ejercicio3Pressdepareddeisquiotibialesconestabilidadcostal() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 3: Press de Pared de Isquiotibiales con Estabilidad Costal"      backButtonText="Semana 5 - Día 3"
      videoId="wn0IyvGBeUI"
      videoStart={2248}
    ...
    >
      <EspDrillNavBar 
        prevDrill="/espanol/semana5/dia3/ejercicio2" 
        currentDay="/espanol/semana5/dia3" 
        nextDrill="/espanol/semana5/dia3/ejercicio4" 
