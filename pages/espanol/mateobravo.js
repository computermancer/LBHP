    ...
    <>
      ...
      <main className="px-8 text-gray-200 min-h-screen font-sans">
        <div className="max-w-[500px] mx-auto py-8">
          ...
          <h2 className="text-orange-300 text-xl font-semibold mb-4">Sobre el Creador</h2>
          ...
          <div className="space-y-6">
            ...
            <section>
              <p className="text-lg leading-relaxed mb-4">
                Es increíble lo impactantes que pueden ser los pequeños cambios.
              </p>
            </section>
            ...
            <section>
              <p className="text-lg leading-relaxed mb-4">
                ¡Ya no tenía miedo de estornudar!
              </p>
            </section>
