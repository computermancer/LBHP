...
export default function Ejercicio3Torsindecolumnasentadoconextensindebrazos() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 3: Torsión de Columna Sentado con Extensión de Brazos"      backButtonText="Semana 3 - Día 5"
      videoId=""
      videoStart={0}
      ...
      instructions={[" Inhala para prepararte."," Exhale y gire la parte superior del cuerpo hacia un lado, extendiendo un brazo hacia delante."," Vuelva al centro antes de girar al otro lado."," Conjuntos: 2-3","Repeticiones: 8-10 repeticiones lentas por lado"," Respirar: Exhala durante la rotación, inhala para volver","Descanso: Según sea necesario"]}
      setsReps={[]}
