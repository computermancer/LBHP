...
export default function Ejercicio4Marchaapoyadaenlaparedconcontroldecostillas() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 4: Marcha Apoyada en la Pared con Control de Costillas"
      ...
      instructions={[
        ...
        "Levante ligeramente un pie de la pared manteniendo el control de las costillas.",
      ...
      whatToFeel={[
        "Activación del núcleo y estabilidad de las costillas.",
