...
export default function Ejercicio4RockBackcuadrpedoconconcentracinenlarespiracin() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 4: Rock Back Cuadrúpedo con Concentración en la Respiración"      backButtonText="Semana 3 - Día 1"
      videoId="wn0IyvGBeUI"
      videoStart={2248}
      ...
      instructions={[" Inhala para prepararte."," Exhale y desplace lentamente las caderas hacia los talones."," Inhale y vuelva a la posición inicial."," Conjuntos: 2-3","Repeticiones: 8-10 repeticiones lentas","Respira: Exhala para retroceder, inhala para regresar","Descanso: Según sea necesario"]}
      setsReps={[]}
      whatToFeel={[" Movimiento pélvico suave con control del núcleo."," Arqueamiento o redondeo mínimo de la columna vertebral."]}
