  ...
  return (
    <EspDrillBarTemplate
      ...
      setup={[
        ...
        "Manos apoyadas suavemente sobre los muslos."
      ]}
      instructions={[
        "Inhala para prepararte.",
        "Exhala y desplaza suavemente una cadera hacia delante manteniendo la estabilidad de las costillas.",
        "Vuelva a la posición neutra y alterne los lados."
      ]}
      setsReps={[
        "Conjuntos: 2-3",
      ...
      whatToFeel={[
        "Cambio de cadera suave y controlado.",
        "La caja torácica permanece neutra y estable."
      ]}
      whatToAvoid={[
        "Inclinación o torsión del torso."
      ]}
      redFlags={[
        "Dolor o molestias en las caderas o la zona lumbar."
      ]}
      regression={[
        "Realice con cambios más pequeños para un mejor control."
      ]}
    >
      <EspDrillNavBar 
