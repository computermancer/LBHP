...
export default function Ejercicio1Movimientosdecaderaendecbitosupinoconcontroldecostillas() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 1: Movimientos de Cadera en Decúbito Supino con Control de Costillas"
      ...
      instructions={[
        "Exhale y mueva una cadera ligeramente más alta que la otra.",
      ...
      whatToFeel={[
        "Sutil movimiento de cadera con estabilidad costal.",
        "Cambios suaves y controlados."
      ]}
      whatToAvoid={[
        "Perder el control de la caja torácica y la pelvis."
      ]}
      redFlags={[
        "Dolor o molestias en las caderas o la columna vertebral."
      ]}
      regression={[
        "Realice turnos más pequeños para mejorar el control."
      ]}
    >
      <EspDrillNavBar 
