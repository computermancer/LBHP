...
export default function Ejercicio5Abduccinlateraldecaderaconapoyo() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 5: Abducción Lateral de Cadera con Apoyo"
      ...
      instructions={[
        ...
        "Exhale y levante ligeramente la pierna de arriba sin rotar la pelvis.",
        "Mantenga durante 2-3 segundos, luego volver."
      ]}
      setsReps={[
        "Conjuntos: 2-3",
      ...
      whatToFeel={[
        "Activación de los glúteos y control de la cadera.",
        "Estabilidad pélvica en todo momento."
      ]}
      whatToAvoid={[
        "Rodar la pelvis o subir la cadera."
      ]}
      redFlags={[
