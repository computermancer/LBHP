  ...
  return (
    <EspDrillBarTemplate
      ...
      instructions={[
        ...
        "Exhale y balancee suavemente la pelvis hacia atrás, aplanando la parte baja de la espalda.",
      ...
      whatToFeel={[
        ...
        "Compromiso del núcleo durante el movimiento."
      ]}
      whatToAvoid={[
      ...
      regression={[
        "Limite la amplitud de movimiento para un mejor control."
      ]}
    >
      <EspDrillNavBar 
