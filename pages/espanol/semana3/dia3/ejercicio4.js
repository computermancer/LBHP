...
export default function Ejercicio4Sentadillaapoyadaenlaparedconalcance() {
  return (
    <EspDrillBarTemplate
      title="Ejercicio 4: Sentadilla Apoyada en la Pared con Alcance"      backButtonText="Semana 3 - Día 3"
      videoId="wn0IyvGBeUI"
      videoStart={2248}
      ...
      instructions={[" Exhale y baje lentamente en cuclillas, manteniendo el control de las costillas y la pelvis."," Mantenga durante 10-20 segundos."," Inhala y vuelve a ponerte de pie."," Conjuntos: 2-3","Repeticiones: 2-3"," Respiración: Respiración constante durante todo el recorrido","Descanso: 30-60 segundos entre series"]}
      setsReps={[]}
