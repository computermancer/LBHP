...
export default function Ejercicio4MarchaApoyadaEnParedConControlCostal() {
  return (
    <DrillTemplateEspanol
      title="Ejercicio 4: Marcha Apoyada en Pared con Control Costal"
      ...
      instructions={[
        "Exhala y presiona suavemente tus talones contra la pared.",
        "Levanta un pie ligeramente de la pared mientras mantienes el control costal.",
      ...
      whatToFeel={[
        "Activación del core y estabilidad costal",
