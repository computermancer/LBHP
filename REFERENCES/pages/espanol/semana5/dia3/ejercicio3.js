...
export default function Ejercicio3PresionDeIsquiotibialesEnParedConEstabilidadCostal() {
  return (
    <DrillTemplateEspanol
      title="Ejercicio 3: Presión de Isquiotibiales en Pared con Estabilidad Costal"
      ...
      setsReps={[
        "Series: 2-3",
        "Repeticiones: Mantenimiento de 5-8 segundos",
